...
(function($) {
        ...
        if (elements.length > 1) {
            ...
            if (settings.type === "sequence") {
                ...
                setTimeout(function() {
                    ...
                    } while (last === current );                                $.innerfade.next(elements, settings, current, last);
                }, settings.timeout);
                $(elements[last]).show();
              ...
              window.alert('Innerfade-Type must either be \'sequence\', \'random\' or \'random_start\'');
            }
        }
    };
    ...
    $.innerfade.next = function(elements, settings, current, last) {
        if (settings.animationtype === 'slide') {
            ...
            window.alert('Innerfade-animationtype must either be \'slide\' or \'fade\'');
        }
        if (settings.type === "sequence") {
